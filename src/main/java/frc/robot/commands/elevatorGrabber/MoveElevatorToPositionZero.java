...
public class MoveElevatorToPositionZero extends CommandBase {
     ...
     */
    public MoveElevatorToPositionZero(ElevatorGrabber elevatorGrabber, double targetPositionMeters) {
        // addRequirements(elevatorGrabber);
        this.elevatorGrabber = elevatorGrabber;
        this.targetPositionMeters = 0;
        timer = new Timer();
    }
