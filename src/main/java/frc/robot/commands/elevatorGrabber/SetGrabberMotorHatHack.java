...
public class SetGrabberMotorHatHack extends CommandBase {
   ...
   */
  public SetGrabberMotorHatHack(ElevatorGrabber elevatorGrabber, double voltage, double ampLimit, CubeHatHack hatHack) {
