...
public class EjectGamePiece extends SequentialCommandGroup {
   ...
   */
  public EjectGamePiece(Intake intake, Elevator elevator, Conveyor conveyor, IndexerWalls indexerWalls, GrabberPlacer grabberPlacer, double intakeMotorVoltage, double conveyorMotorVoltage, double indexerMotorVoltage, double grabberPlacerVolts) {
    addCommands(
