...
public class ElevatorGrabber extends SubsystemBase {
  ...
  //this pidcontroller is used to keep the elevator in a desired position when it is not moving
  ...
  public ElevatorGrabber() {
    ...
    positionController = new PIDController(6, 0, 0);
